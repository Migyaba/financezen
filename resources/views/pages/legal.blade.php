<x-public-layout :title="'Mentions Légales — FinanceZen'">
    <section class="py-16 md:py-24 px-4 sm:px-6">
        <div class="max-w-3xl mx-auto">
            <div class="mb-10">
                <h1 class="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tight">Mentions Légales</h1>
                <p class="text-slate-500">Informations relatives à l'éditeur et à l'hébergement du site FinanceZen.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 space-y-8">
                ...
                <hr class="border-slate-100">
                <div>
                    <h2 class="text-lg font-black text-slate-800 mb-3 flex items-center gap-2"><i data-lucide="server" class="w-5 h-5 text-primary"></i> 3. Hébergement</h2>
                    <p class="text-sm text-slate-600 leading-relaxed">Le site est hébergé par o2switch, SARL au capital de 100 000 euros, situé au Chemin des Pardiaux, 63000 Clermont-Ferrand, France. Téléphone : 04 44 44 60 40.</p>
                </div>
                <hr class="border-slate-100">
                <div>
                    <h2 class="text-lg font-black text-slate-800 mb-3 flex items-center gap-2"><i data-lucide="shield" class="w-5 h-5 text-primary"></i> 4. Propriété intellectuelle</h2>
                    <p class="text-sm text-slate-600 leading-relaxed">L'ensemble de ce site relève de la législation française et internationale sur le droit d'auteur et la propriété intellectuelle. Tous les droits de reproduction sont réservés, y compris pour les documents téléchargeables et les représentations iconographiques et photographiques.</p>
                </div>
                <hr class="border-slate-100">
                <div>
